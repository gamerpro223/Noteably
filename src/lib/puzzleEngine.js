...
export const LEVEL_META = {
  1:  { name: "Keyboard Orientation", description: "Single notes around middle C, then tiny two-note moves." },
  2:  { name: "Five-Finger Reading",  description: "C-G and G-D positions with short stepwise patterns." },
  3:  { name: "Beginner Melodies",    description: "Short public-domain style phrases using steps and repeats." },
  4:  { name: "Skips And Landings",   description: "Thirds, fourths, fifths, and simple phrase endings." },
  5:  { name: "First Chord Shapes",   description: "Intervals, blocked triads, and broken triads." },
  6:  { name: "Notes Into Chords",    description: "Simple melodies that resolve into chords." },
  7:  { name: "Song Phrases",         description: "Public-domain style melodies with eighth notes." },
  8:  { name: "Wider Reading",        description: "Larger range, accidentals, and faster note recognition." },
  9:  { name: "Triads In Motion",     description: "Chord progressions, broken triads, and inversions begin." },
  10: { name: "Inversion Control",    description: "Root, first, and second inversions in short progressions." },
  11: { name: "Rhythm And Accidentals", description: "Syncopation, dotted rhythms, accidentals, and leaps." },
  12: { name: "Two-Hand Coordination", description: "Melody plus bass patterns, with both hands truly active." },
  13: { name: "Sevenths And Broken Bass", description: "Seventh chords, Alberti bass, and denser coordination." },
  14: { name: "Repertoire Passages",  description: "Longer classical-style passages with memory pressure." },
  15: { name: "Independent Hands",    description: "Different rhythms in each hand, syncopation, and sevenths." },
  16: { name: "Advanced Harmony",     description: "Complex progressions, chromatic color, and wider leaps." },
  17: { name: "Key Changes",          description: "Dense chromatic reading, shifting keys, and advanced rhythm." },
  18: { name: "Virtuoso Passages",    description: "Rapid arpeggios, wide leaps, and difficult two-hand textures." },
  19: { name: "Concert Study",        description: "Multi-octave figuration, dense chords, and chromatic passages." },
  20: { name: "Grandmaster Trial",    description: "Everything at once: speed, harmony, leaps, rhythm, and density." },
};
